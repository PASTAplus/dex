...
STATIC_PATH = first_existing("webapp/static")
...
PROFILING_SH_PATH = first_existing("webapp/profiling_proc.sh", is_file=True)
PROFILING_PY_PATH = first_existing("webapp/profiling_proc.py", is_file=True)
# PROFILING_LOGS_PATH = ROOT_PATH / '..' / "dex-logs/profiling.log"
PROFILING_CONFIG_PATH = first_existing('webapp/profiling_config.yml', is_file=True)
